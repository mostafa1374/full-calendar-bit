...
namespace BitPlatformTemplate.Iac;
    ...
    public AppStack()
    {
        ...
        WebApp webApp = new($"app-service-app-{stackName}", new()
        {
            ...
            SiteConfig = new SiteConfigArgs
            {
                ...
                AppCommandLine = "dotnet BitPlatformTemplate.Server.dll",
                AppSettings =
                [
        ...
        Secret sqlDatabaseConnectionStringSecret = new(sqlDatabaseConnectionStringSecretName, new()
        {
            ...
            Properties = new SecretPropertiesArgs
            {
                Value = Output.Tuple(sqlServer.Name, sqlDatabase.Name, sqlDatabaseDbAdminPassword).Apply(t =>
                {
                    ...
                    return $"Data Source=tcp:{_sqlServer}.database.windows.net;Initial Catalog={_sqlDatabase};User ID={sqlDatabaseDbAdminId};Password={_sqlDatabasePassword};Application Name=BitPlatformTemplate;Encrypt=True;";
                })
            }
        });
    }
