using BitPlatformTemplate.Client.Core.Controllers.Categories;
using BitPlatformTemplate.Client.Core.Controllers.Product;
using BitPlatformTemplate.Shared.Dtos.Products;

namespace BitPlatformTemplate.Client.Core.Components.Pages.Products;
