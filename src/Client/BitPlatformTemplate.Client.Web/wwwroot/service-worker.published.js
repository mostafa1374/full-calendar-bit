...
self.assetsExclude = [
    ...
    /Client\.Web\.styles\.css$/ // In .NET 8, an inexistent CSS file is inadvertently included in the assets list under the name 'BitPlatformTemplate.Client.Web.styles.css.'
