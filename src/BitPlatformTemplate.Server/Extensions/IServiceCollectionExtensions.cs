...
using BitPlatformTemplate.Server;
using BitPlatformTemplate.Server.Models.Identity;
using BitPlatformTemplate.Server.Services;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "BitPlatformTemplate.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "BitPlatformTemplate.Shared.xml"));
